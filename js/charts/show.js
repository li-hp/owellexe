...
//symbolSize 散点气泡大小
var symbolSizeData = [100, 110, 120, 130, 135];
//
//循环定义series的data值
var datas = [];
...
setInterval(function () {
    ...
    function e555() {
        ...
        var dataBJ = [
            [15,97,26,0.46,18,6,8,1," 会议区"],
            [3,45,23,0.46,18,6,8,1," 休闲区"],
        
        ];
        
        var dataGZ = [
            [12,20,25,0.46,18,6,8,1," 办公区"],
            [25,70,25,0.46,18,6,8,1," 办公区2"],
    
        ];
        
        var dataSH = [
            [11,60,27,0.46,18,6,8,1," 阳台"],
            [15,80,26,0.46,18,6,8,1," 茶水间"],
    ...
    function e999() {
        ...
        var yzhou;
        let data1=['办公人数', '请假人数', '来访人数','开会人数','开门数量','开窗数量'];
  let data2=[150, 20, 60,40,10,20];
   let option = {
        ...
        series: [{
                ...
                itemStyle:{
                    color : function(params) {
						var colorList = ['#00ABDA','#D1B50E','#6bdde2','#00ABDA','#D1B50E','#7ACC10'];
